...
This is a photohub project for the PHP/SQL course at Laurea UAS. The idea was to make a simple gallery, where users can save thier images, view and delete them, but as well view images uploded by other users as well
...
Or you can import database by using photohub.sql which is easer and faster. Check, are the table relations are functioning properly 
